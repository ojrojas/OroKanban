...
public sealed class DocumentConfiguration : IEntityTypeConfiguration<Document>
{
    public void Configure(EntityTypeBuilder<Document> b)
    {
        ...
        b.HasKey(x => x.Id);
        b.Property(x => x.Id).HasConversion(id => id.Value, v => new Domain.Ids.DocumentId(v));
        ...
        b.Property(x => x.CurrentVersionId).HasConversion(id => id.Value, v => new Domain.Ids.DocumentVersionId(v));
        ...
        b.Property(x => x.Status).HasConversion(s => s.Id, id => Domain.Enumerations.DocumentStatus.FromId(id));
